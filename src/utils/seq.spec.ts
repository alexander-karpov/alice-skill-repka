...
describe('findSeq', () => {
    test('Undefined при несовместимых длинах', async () => {
        ...
        expect(findSeq(seq, pattern)).toBeUndefined();
    });
    ...
    test('OK когда в начале', async () => {
        ...
        expect(findSeq(seq, pattern)).toEqual([1, 2, 3]);
    });
    ...
    test('OK когда в середине', async () => {
        ...
        expect(findSeq(seq, pattern)).toEqual([2, 3, 4]);
    });
    ...
    test('OK когда в конце', async () => {
        ...
        expect(findSeq(seq, pattern)).toEqual([3, 4, 5]);
    });
    ...
    test('OK когда один в начале', async () => {
        ...
        expect(findSeq(seq, pattern)).toEqual([1]);
    });
    ...
    test('OK когда один в середине', async () => {
        ...
        expect(findSeq(seq, pattern)).toEqual([3]);
    });
    ...
    test('OK когда один в конце', async () => {
        ...
        expect(findSeq(seq, pattern)).toEqual([5]);
    });
