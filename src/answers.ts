...
const ABOUT_SKILL =
    'Я расскажу вам сказку про репку, если вы мне поможете. Когда придет время позвать на помошь нового героя, дополните рассказ. Например, я скажу: "Позвал дедка...", а вы продолжите: "Силача". Вы готовы?';
