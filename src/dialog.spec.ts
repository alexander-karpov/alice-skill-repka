...
describe('Main dialog', () => {
    ...
    test('Персонажи с озвучкой', async () => {
        await text('');

        // prettier-ignore
        for (const char of [
            'внучка','слон', 'собака', 'ворона', 'сова', 'курочка', 'лисичка', 'волк', 'петушок', 'котик', 'мишка',
            'кошка', 'жучка', 'кот', 'дед',  'медведь', 'собачка', 'петух',
            'лев', 'котенок', 'дочка', 'курица', 'рыбка', 'крыса', 'корова', 'крокодил', 'тигр',
            // 'баба', 'папа', 'мама','алиса', 'бабка', 'бабушка', 'папка', 'дедушка', 'динозавр', 'привет', 'заяц', 'баку', 'пока', 'лиса', 'единорог', 'ну', 'маша', 'давать', 'муравей', 'брат', 'дракон', 'поп', 'колобок', 'попугай', 'дебил',
            // 'рыба', 'зомби', 'девочка', 'как', 'жираф', 'у', 'о', 'внук', 'человек', 'не', 'проститутка', 'котик', 'сосед', 'лягушка', 'бомж', 'бегемот', 'баба', 'бабочка',
